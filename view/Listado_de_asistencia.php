...
<body class="back-style">
    ...
    <h1 class="subtext-style">1LS-131</h1>
    ...
    <div>
        ...
        <button class="btn-estilo">Guardar</button>
    </div>  

    <section class="home"></section>
    <table id="tabla" style="width: 100%;" class="in-flex">
        <tr>
            <th>Nombre</th><th>Apellido</th><th>Correo</th><th>Cédula</th><th>Asistencia</th><th>Porcentaje</th><th>Observaciones</th></tr>

            <tr><td>Carlos</td><td>Fernández</td><td>carlos.fernandez3@utp.ac.pa</td><td>8-976-518</td>
            <td><img src="https://emojitool.com/img/apple/ios-15.4/large-green-circle-3377.png"></td>
            <td> 5%</td><td>El estudiante no se bañó</td></tr>

    ...
    <div class="contenido contenedor">
        ...
        <div class="contenido-main" style="padding: 10px;">
            <div class="shadow-sm p-3 bg-body rounded">
                ...
                <p class="text-center <?php if (isset($_GET['t'])) {
                    echo $_GET['t'];
                } ?>">
                    ...
                    <div class="row input-group">
                        <div class="mb-3">
                            ...
                            <select class="form-select m-2 inputs-style" name="producto" aria-label="Default">
                                ...
                                <option value="<?php echo $p->equipo ?>">
                                    <?php echo $p->equipo ?>
                                </option>
                                <?php } ?>
                            </select>
                        ...
                        <div class="col">
                            <div class="mb-3">
                                <label for="" class="form-label font-weight-bold">Ingrese la cantidad a
                                    solicitar:</label>
                                <input name="cantidad" type="number" class="form-control mb-3 inputs-style"
                                    id="floatingInput" placeholder="">
                            </div>

                            <div class="mb-3">
                                <label for="" class="form-label font-weight-bold">Profesor que realiza la
                                    solicitud:</label>
                                <input name="profesor" value="<?php echo $_SESSION['user_name']; ?>" disabled
                                    type="text" class="form-control mb-3 inputs-style" id="floatingInput"
                                    placeholder="Profesor">
                            </div>
                            <div class="mb-3">
                                <label for="" class="form-label font-weight-bold">Correo del profesor:</label>
                                <input name="correo" value="<?php echo $datos->correo; ?>" disabled type="text"
                                    class="form-control mb-3 inputs-style" id="floatingInput" placeholder="Correo">
                            </div>
                            <div class="mb-3">
                                <label for="" class="form-label font-weight-bold">Fecha de solicitud:</label>
                                <input name="fecha" value="<?php echo date("Y-m-d") ?>" type="text" disabled
                                    class="form-control mb-3 inputs-style" id="floatingInput" placeholder="Correo">
                            </div>
                        </div>
                    </div>
